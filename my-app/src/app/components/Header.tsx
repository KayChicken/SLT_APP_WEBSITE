            ...
            <div className="container">
                <div className="header__container">
                    ...
                    <div className="header__darkmode">
                        <div className="darkmode__block" onClick={() => {setSwitcher(!switcher)}}>
                            <div className={`darkmode__switcher ${switcher ? 'swipe' : ''}`}></div>
                            <svg className='darkmode__switch moon' width="28px" height="28px" viewBox="0 0 24 24" fill="none">
                            ...
                            <svg className='darkmode__switch' width="28px" height="28px" viewBox="0 0 24 24" fill="none">
